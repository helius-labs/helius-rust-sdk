...
async fn test_append_addresses_to_webhook_success(){
    ...
    let response = helius.append_addresses_to_webhook("0e8250a1-ceec-4757-ad69",&["71WDyyCsZwyEYDV91Qrb212rdg6woCHYQhFnmZUBxiJ6".to_string()]).await;
...
async fn test_append_addresses_to_webhook_failure(){
    ...
    let response:Result<Webhook,HeliusError> = helius.append_addresses_to_webhook("0e8250a1-ceec-4757-ad69",&["71WDyyCsZwyEYDV91Qrb212rdg6woCHYQhFnmZUBxiJ6".to_string()]).await;
